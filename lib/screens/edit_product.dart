...
class EditProduct extends StatelessWidget {
  ...
  Future updateProduct() async {
    final response = await http.put(Uri.parse('http://127.0.0.1:8000/api/products/' + product['id'].toString()), body: {
              ...
              ElevatedButton(onPressed: () {
                if(_formKey.currentState!.validate()) {
                  updateProduct().then((value) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Product has been updated successfully.')));
                  });
                }
              }, child: Text('Update'))
            ],
